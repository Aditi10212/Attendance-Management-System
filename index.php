 ...
 <head>
  ...
  <script src="js/login.js"></script>
   <!-- Custom styles for this template -->
    ...
    <style>
         body {
            background-image: url("https://cache.careers360.mobi/media/presets/720X480/colleges/social-media/media-gallery/282/2017/12/1/Manipal-University-Jaipu2r.jpg");
