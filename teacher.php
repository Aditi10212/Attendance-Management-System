...
<html>
 <head>
  ...
  <!-- Custom styles -->
    ...
    <style>
         body {
            background-image: url("https://www.xmple.com/wallpaper/red-stripes-lines-blue-green-streaks-purple-white-1920x1080-c7-0000ff-9400d3-f0ffff-66cdaa-9acd32-ff0000-ffffff-l7-25-50-100-200-400-800-1600-a-120-f-1.svg");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Smart Attendance</a>
        </div>
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CSE-322">
              <select class="form-control" name="section">
              <option value="-1">Choose Section</option>
              <?php foreach(range(1,5) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <select class="form-control" name="semester">
              <option value="-1">Choose Semester</option>
              <?php foreach(range(1,8) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 201/CS/24)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 265/CS/24)">
