 ...
 <div class="container">
  ...
  <form id="getAttendance">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="roll" placeholder="Eg - 262/CS/24">
      <span class="help-block">NNN/DD/YY where N : Number, D : Department , Y : Year of passing</span>
    </div>
